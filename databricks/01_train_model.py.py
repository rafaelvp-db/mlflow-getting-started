...
# MAGIC %md
# MAGIC 
# MAGIC # MLflow quickstart: training and logging  
# MAGIC 
...
# MAGIC 
# MAGIC ### Note
# MAGIC This notebook was originally published as a [Databricks Notebook](https://community.cloud.databricks.com/?o=3797818470089835#notebook/3246829711022031/command/3246829711022032). Click the link for more details.
...
import os
mlflow.set_experiment(experiment_name = "/Shared/elastic_net_experiment")

# COMMAND ----------

# MAGIC %md
# MAGIC 
# MAGIC ## Create function to plot ElasticNet descent path
...
def plot_enet_descent_path(X, y, l1_ratio):
    ...
    # Save figure
    fig.savefig("/dbfs/tmp/ElasticNet-paths.png")
...
# MAGIC %md
# MAGIC 
# MAGIC ## Train the diabetes model
...
def train_diabetes(data, in_alpha, in_l1_ratio):
  ...
  with mlflow.start_run(run_name = "my_run"):
    ...
    mlflow.log_artifact("/dbfs/tmp/ElasticNet-paths.png")
